...
describe('NON_BROWSER_TOOLS', () => {
  test('contains 12 non-browser tools', () => {
    expect(NON_BROWSER_TOOLS).toHaveLength(12);
    ...
    expect(names).toContain('openhuman_list_tools');
    expect(names).toContain('openhuman_search_memory');
    expect(names).toContain('openhuman_call_integration');
  });
