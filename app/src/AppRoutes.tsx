...
import GigiSetup from './pages/GigiSetup';
import GigiDashboard from './pages/GigiDashboard';
...
const AppRoutes = () => {
  ...
  return (
    <Routes>
      ...
      {/* Gigi first-run setup wizard — fully public, no auth gate */}
      <Route path="/setup" element={<GigiSetup />} />

      {/* Gigi main dashboard */}
      <Route path="/gigi" element={<GigiDashboard />} />
